...
Encore.addEntry('sweetalert', './resources/js/sweetalert.js')
// Encore.addEntry('bootstrap', './resources/js/bootstrap.js')
...
*/
Encore.copyFiles({
  from: './resources/css/fontawesome/svgs',
  to: 'svgs/[path][name].[hash:8].[ext]',
})
